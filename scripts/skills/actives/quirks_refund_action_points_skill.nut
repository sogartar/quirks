this.quirks_refund_action_points_skill <- this.inherit("scripts/skills/skill", {
  m = {
    ActionPontsRefund = 0,
  },
  function create()
  {
    this.m.ID = "actives.quirks.refund_action_points";
    this.m.Name = this.Const.Strings.PerkName.QuirksRefundActionPoints;
    this.m.Icon = "ui/actives/active_quirks_refund_action_points.png";
